...
add_executable(AS_05_default_image_WN8WZfn_ ${AS_05_default_library_list})

set_target_properties(AS_05_default_image_WN8WZfn_ PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    ADDITIONAL_CLEAN_FILES "${output_extensions}"
    RUNTIME_OUTPUT_DIRECTORY "${AS_05_default_output_dir}")
target_link_libraries(AS_05_default_image_WN8WZfn_ PRIVATE ${AS_05_default_default_XC8_FILE_TYPE_link})

# Add the link options from the rule file.
AS_05_default_link_rule( AS_05_default_image_WN8WZfn_)

...
add_executable(AS_03_default_image_aNhRMs__ ${AS_03_default_library_list})

set_target_properties(AS_03_default_image_aNhRMs__ PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    ADDITIONAL_CLEAN_FILES "${output_extensions}"
    RUNTIME_OUTPUT_DIRECTORY "${AS_03_default_output_dir}")
target_link_libraries(AS_03_default_image_aNhRMs__ PRIVATE ${AS_03_default_default_XC8_FILE_TYPE_link})

# Add the link options from the rule file.
AS_03_default_link_rule( AS_03_default_image_aNhRMs__)
